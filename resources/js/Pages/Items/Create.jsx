            ...
            <div className="relative bg-gradient-to-br from-white via-green-50/30 to-white border-b border-gray-200 overflow-hidden">
                ...
                <div className="relative px-6 py-6">
                    <nav className="flex items-center space-x-2 text-sm mb-4">
                        ...
                        <span className="text-[#37692F] font-medium">Create Item</span>
                    </nav>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900 mb-1">Create New Item</h1>
                                <p className="text-gray-600">Add a new fertilizer or pesticide to your inventory</p>
                            </div>
                        </div>
                    </div>
                </div>
