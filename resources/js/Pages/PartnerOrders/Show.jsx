...
// ...existing code...
// The new layout will be implemented here, matching the Buyback Contract Details format from the screenshot.
// For brevity, the code will be replaced with a new functional component using the same data props and structure, but with the updated layout and styling.
