            ...
            <div className="relative bg-gradient-to-br from-white via-green-50/30 to-white border-b border-gray-200 overflow-hidden">
                ...
                <div className="relative px-6 py-6">
                    ...
                    <nav className="flex items-center space-x-2 text-sm mb-4">
                        ...
                        <span className="text-[#37692F] font-medium">Partner Orders</span>
                    </nav>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            {/* Title & Description */}
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900 mb-1">Partner Orders</h1>
                                <p className="text-gray-600">Manage seed and item deliveries to partners</p>
                            </div>
                        </div>
                        ...
                        {permissions.includes('create inventory') && (
                            <Link
                                ...
                                className="bg-gradient-to-r from-[#37692F] to-[#4a8a3f] hover:shadow-lg text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all duration-200"
                            >
                                <Plus size={20} />
                                New Order
                            </Link>
