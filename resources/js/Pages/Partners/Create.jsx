            ...
            <div className="relative bg-gradient-to-br from-white via-green-50/30 to-white border-b border-gray-200 overflow-hidden">
                ...
                <div className="relative px-6 py-6">
                    <nav className="flex items-center space-x-2 text-sm mb-4">
                        ...
                        <span className="text-[#37692F] font-medium">Create Partner</span>
                    </nav>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900 mb-1">Create New Partner</h1>
                                <p className="text-gray-600">Add a new partner to your network</p>
                            </div>
                        </div>
                    </div>
                </div>
