...
export default function ContractForm({ partners, seeds, contract = null }) {
    ...
    const [selectedSeeds, setSelectedSeeds] = useState(contract?.seeds || []);
        ...
        <div className="p-6">
            ...
            <div className="px-6 pt-6">
                <nav className="text-sm text-gray-600">
                    ...
                    / <Link href={route('contracts.index')} className="text-[#37692F] hover:underline">Contracts</Link> / <span>{contract ? 'Edit' : 'Create'} Contract</span>
                </nav>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 mt-4">
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-2 pt-6 border-t border-gray-200">
                        ...
                        >
                            {processing ? (contract ? 'Updating...' : 'Creating...') : (contract ? 'Update Contract' : 'Create Contract')}
                        </button>
                    </div>
                </form>
            </div>
