...
const ShowDamageModal = ({ open, form, onSubmit, onClose }) => {
  if (!open) return null;
      ...
      <div className="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        <div className="mb-4 flex flex-col items-center">
          ...
          <p className="mt-1 text-center font-poppins text-sm text-gray-500">
            Document plant damage and issues
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="mt-6 flex justify-center space-x-3">
            <button
              ...
              className="flex-1 rounded-lg bg-orange-600 px-5 py-3 font-poppins text-sm font-medium text-white transition-colors hover:bg-orange-700 disabled:opacity-50"
            >
              {form.processing ? (
...
export default ShowDamageModal;