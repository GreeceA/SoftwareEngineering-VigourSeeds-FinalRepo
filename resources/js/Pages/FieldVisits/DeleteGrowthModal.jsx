...
const DeleteGrowthModal = ({ open, growthReport, onCancel, onConfirm }) => {
    if (!open) return null;
            ...
            <div className="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
                ...
                <div className="mb-6 rounded-lg bg-gray-50 p-4 border border-gray-200">
                    <div className="space-y-2">
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm font-semibold text-gray-900">{growthReport.stage || 'N/A'}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm font-medium text-gray-600">Status:</span>
                            <span className="text-sm font-semibold text-gray-900">{growthReport.status || 'N/A'}</span>
                        </div>
                        {growthReport.notes && (
                            <div className="mt-2 pt-2 border-t border-gray-200">
                                <span className="text-sm font-medium text-gray-600">Notes:</span>
                                <p className="mt-1 text-sm text-gray-700 line-clamp-2">{growthReport.notes}</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="mb-6 rounded-lg border-l-4 border-red-500 bg-red-50 p-3">
                    <p className="text-center font-poppins text-sm font-medium text-red-800">
                        ⚠️ Are you sure you want to delete this growth report? This action is permanent.
                    </p>
                </div>
                ...
                <div className="flex justify-center space-x-3">
                    ...
                    <button
                        onClick={() => onConfirm(growthReport.growth_ID)}
...
export default DeleteGrowthModal;